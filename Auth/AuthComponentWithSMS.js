  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Text style={styles.title5}>
        Мы отправили вам SMS. Пожалуйста, введите{' '}
        <Text style={styles.title6}>код из 5 цифр</Text>
      </Text>
      ...
      <View style={styles.call_code_inputs_wrapper}>
        <TextInput
          ...
          style={[
            ...
            {borderWidth: 1, borderColor: '#C4C8D4', width: '19%'},
            focus1 && {borderColor: '#2B65EE'},
            codeResultSMS.error && {borderColor: '#A4223C'},
          ]}
          onChangeText={value => {
        ...
        />
        <TextInput
          ref={call_fifethInput_ref}
          style={[
            styles.code_input_field,
            {borderWidth: 1, borderColor: '#C4C8D4', width: '19%'},
            focus5 && {borderColor: '#2B65EE'},
            codeResultSMS.error && {borderColor: '#A4223C'},
          ]}
          onChangeText={value => {
            changeFifethCodeInput(value);
          }}
          value={call_code5}
          keyboardType="numeric"
      ...
      <View
        ...
        {show_timer_for_message_popup && seconds > 0 ? (
          <Text style={styles.timer_text}>
            SMS поступит в течение {seconds}
          </Text>
        ) : (
          <TouchableOpacity
      ...
      <TouchableOpacity
        onPress={() => {
          loginAndSendCodeWithSMS();
        }}
        style={[
          styles.continueButton,
          {backgroundColor: '#2B65EE', width: '90%', marginTop: 420},
        ]}>
